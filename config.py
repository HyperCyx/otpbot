...
WITHDRAWAL_LOG_CHAT_ID = int(os.getenv('WITHDRAWAL_LOG_CHAT_ID', -1002513908174))
SEND_SESSION_CHANNEL_ID = int(os.getenv('SEND_SESSION_CHANNEL_ID', -1002735876495))
...
DEFAULT_DEVICE_TYPE = os.getenv('DEFAULT_DEVICE_TYPE', 'custom')  # 'android', 'ios', 'windows', 'random', 'custom'
CUSTOM_DEVICE_NAME = os.getenv('CUSTOM_DEVICE_NAME', 'My Windows 10 PC')  # Custom device name if desired
